...
class StripWidget(ttk.Labelframe):
    def __init__(self, index, *args, **kwargs):
        ...
        self.dial = Dial(self).grid(row=0, column=0, sticky="NSEW")
        self.dial = Dial(self).grid(row=0, column=1, sticky="NSEW")
        
        self.slider = Slider(self).grid(row=1, rowspan=5, column=0, sticky="NSEW")
        
        self.button1 = Button(self).grid(row=1, column=1, sticky="NSEW")
        self.button2 = Button(self).grid(row=2, column=1, sticky="NSEW")
        self.button3 = Button(self).grid(row=3, column=1, sticky="NSEW")
        self.button4 = Button(self).grid(row=4, column=1, sticky="NSEW")
        self.button5 = Button(self).grid(row=5, column=1, sticky="NSEW")
...
class BusWidget(ttk.Labelframe):
    def __init__(self, index, *args, **kwargs):
        ...
        self.slider = Slider(self).grid(row=0, column=0, sticky="NSEW")
        self.button = Button(self).grid(row=0, column=1, sticky="S")
